...
{
	[Serializable]
	public class Paralysisc : ConditionApplier
	{
		...
		{
			//targetActor.actorInfo.additionalBasicStat.attackSpeed -= targetActor.actorInfo.additionalBasicStat.attackSpeed * 0.5f;
		}
